...
class MainPageLocators(BaseLocators):
    ...
    MODULE_CSS_BUTTON = (
        By.XPATH,
        '//td[text()="Построение КСС с помощью циклового метода"]',
    )
...
class Module18PageLocators(BaseLocators):
    ...
    HELP_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://gl-backend.svtz.ru:5000/odata/downloadImage(name='Help.png')\"]",
    )
    HELP_INFO = (By.XPATH, "/html/body/div/div/div/div[1]/div[3]/div/div[2]/div[1]")

    DONE_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://gl-backend.svtz.ru:5000/odata/downloadImage(name='Complete.png')\"]",
    )

    BLUE_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='blue.jpg')\"]",
    )
    RED_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='red.jpg')\"]",
    )
    MAGENTA_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='magenta.jpg')\"]",
    )
    YELLOW_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='yellow.jpg')\"]",
    )
    GREY_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='grey.jpg')\"]",
    )
    BROWN_BUTTON = (
        By.XPATH,
        "//img[@src=\"http://svtz.ru:5000/odata/downloadImage(name='brown.jpg')\"]",
    )
